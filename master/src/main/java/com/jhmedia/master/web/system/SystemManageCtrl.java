...
public class SystemManageCtrl extends BaseController {
    private Logger logger = LoggerFactory.getLogger(SystemManageCtrl.class);
    ...
    public ModelAndView index(Page page) throws Exception {
        logger.info("SystemManageCtrl index...");
    ...
    public PageData toUpdateZt() {
        logger.info("SystemManageCtrl toUpdateZt...");
